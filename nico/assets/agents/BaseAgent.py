...
from assets.DQN_module import DQN_module
...
class CompassAgent(base_agent.BaseAgent):
    ...
    def __init__(self, agent_file):
        ...
        self.DQN_module = DQN_module(self.batch_size, self.gamma)
    ...
    def store_transition(self, obs):
        ...
        DQN_module.memory.push(self.state_history_tensor, self.action_idx, reward, next_state_history_tensor, step_type)
