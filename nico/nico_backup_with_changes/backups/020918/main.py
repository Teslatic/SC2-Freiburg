...
def main(unused_argv):
    ...
    # Initalizing
        ...
        print("Performing calculations on {}".format(device))
        ...
        with setup_env(env_file, agent_interface) as env:
            ...
            for _ in range(EPISODES):  # Starting episode
